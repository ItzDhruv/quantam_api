...
// /// Same structs as encryption side
// #[derive(Serialize, Deserialize)]
// pub struct KyberEncryptedKey {
//     pub kem_ciphertext: String,
//     pub encrypted_chacha_key: String,
...
// pub struct DecryptRequest {
//     pub encrypted_payload: EncryptedPayload,
//     pub kyber_secret_key: String, // hex
// }
...
//     if kyber_sk_bytes.len() != 2400 {
//         return Err("invalid kyber secret key length");
//     }
...
//     for entry in &payload.kyber_keys {
//         let kem_ct_bytes = hex::decode(&entry.kem_ciphertext)
//             .map_err(|_| "invalid kem ciphertext hex")?;
...
//         for i in 0..32 {
//             chacha_key[i] = wrapped_key[i] ^ wrapping_key.as_bytes()[i];
//         }
...
// //     kyber_sk_bytes.len(),
// //     2400,
// //     "INVALID Kyber768 SECRET KEY (must be 2400 bytes)"
// // );
...
// //     // Try each Kyber entry (multi-recipient)
// //     for entry in &payload.kyber_keys {
// //         let kem_ct_bytes = hex::decode(&entry.kem_ciphertext)
// //             .map_err(|_| "invalid kem ciphertext hex")?;
...
// //         if let Ok(plaintext) = cipher.decrypt(nonce, ciphertext.as_ref()) {
// //             return Ok(plaintext); // ✅ authorized recipient
// //         }
// //     }
...
//     match decrypt_payload(&req.encrypted_payload, &kyber_sk) {
//         Ok(plaintext) => {
//             // Return raw bytes (client can save as file)
//             (
//                 axum::http::StatusCode::OK,
//                 plaintext,
//             )
